...
from countagent.tools.ask import (
    AskUserTool,
...
from countagent.tools.file_state import FileStateStore, bind_file_states, reset_file_states
from countagent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from countagent.tools.message import MessageTool
from countagent.tools.notebook import NotebookEditTool
from countagent.tools.registry import ToolRegistry
from countagent.tools.search import GlobTool, GrepTool
from countagent.tools.self import MyTool
from countagent.tools.shell import ExecTool
from countagent.tools.spawn import SpawnTool
...
from countagent.utils.helpers import image_placeholder_text
from countagent.utils.helpers import truncate_text as truncate_text_fn
from countagent.utils.progress_events import (
    build_tool_event_finish_payloads,
    build_tool_event_start_payload,
    invoke_on_progress,
    on_progress_accepts_tool_events,
)
from countagent.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE
from countagent.utils.webui_titles import mark_webui_session, maybe_generate_webui_title_after_turn

if TYPE_CHECKING:
    from countagent.infra.config.schema import ChannelsConfig, ExecToolConfig, ToolsConfig, WebToolsConfig
...
class _LoopHook(AgentHook):
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        from countagent.utils.helpers import strip_think
...
class AgentLoop:
    ...
    def __init__(
        ...
        from countagent.infra.config.schema import ExecToolConfig, ToolsConfig, WebToolsConfig
        ...
        # COUNTAGENT_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("COUNTAGENT_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    async def _connect_mcp(self) -> None:
        ...
        from countagent.tools.mcp import connect_mcp_servers
    ...
    def _tool_hint(self, tool_calls: list) -> str:
        ...
        from countagent.utils.tool_hints import format_tool_hints
