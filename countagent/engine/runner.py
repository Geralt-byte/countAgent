...
from countagent.tools.ask import AskUserInterrupt
...
from countagent.utils.runtime import (
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set COUNTAGENT_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("COUNTAGENT_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
