...
This directory contains built-in skills that extend countagent's capabilities.
...
When skills reference large local documentation or logs, prefer countagent's built-in
