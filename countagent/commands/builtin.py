...
from countagent import __version__
from countagent.core.bus import OutboundMessage
from countagent.commands.router import CommandContext, CommandRouter
from countagent.utils.helpers import build_status_content
from countagent.utils.restart import set_restart_notice_to_env
...
async def cmd_restart(ctx: CommandContext) -> OutboundMessage:
    ...
    async def _do_restart():
        ...
        os.execv(sys.executable, [sys.executable, "-m", "countagent"] + sys.argv[1:])
...
async def cmd_status(ctx: CommandContext) -> OutboundMessage:
    ...
    with suppress(Exception):
        from countagent.utils.searchusage import fetch_search_usage
