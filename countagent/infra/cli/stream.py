...
from countagent import __logo__
...
class ThinkingSpinner:
    """Spinner that shows 'countagent is thinking...' with pause support."""

    def __init__(self, console: Console | None = None):
        c = console or _make_console()
        self._spinner = c.status("[dim]countagent is thinking...[/dim]", spinner="dots")
        self._active = False
