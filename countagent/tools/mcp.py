"""MCP client: connects to MCP servers and wraps their tools as native countagent tools."""
...
from countagent.tools.base import Tool
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a countagent Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only countagent Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only countagent Tool."""
