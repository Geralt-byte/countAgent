"""JSON Schema fragment types: all subclass :class:`~countagent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~countagent.tools.base.Schema.validate_json_schema_value` /
  :class:`~countagent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~countagent.tools.base.Schema`.
...
from countagent.tools.base import Schema
