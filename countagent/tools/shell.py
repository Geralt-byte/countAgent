...
from countagent.tools.sandbox import wrap_command
...
class ExecTool(Tool):
    ...
    async def execute(
        ...
        if self.path_append:
            if _IS_WINDOWS:
                ...
                env["COUNTAGENT_PATH_APPEND"] = self.path_append
                command = f'export PATH="$PATH{os.pathsep}$COUNTAGENT_PATH_APPEND"; {command}'
    ...
    def _guard_command(self, command: str, cwd: str) -> str | None:
        ...
        from countagent.infra.security import contains_internal_url
