...
class BaseChannel(ABC):
    ...
    to integrate with the countagent message bus.
    """
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            if self.transcription_provider == "openai":
                from countagent.providers.transcription import OpenAITranscriptionProvider
                ...
                from countagent.providers.transcription import GroqTranscriptionProvider
